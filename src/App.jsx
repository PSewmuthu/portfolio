...
function App() {
	...
	return (
		<div className="app-container">
			...
			<section id="hero" className="hero">
				...
				>
					<div className="hero-profile-container">
						...
						<img
							src={getAssetUrl(personal.image)}
							alt={personal.name}
					...
					<div className="hero-actions">
						...
						<div className="hero-cv-actions">
							<a
								href={getAssetUrl(personal.cv_url)}
								target="_blank"
							...
							{personal.kaggle && (
								...
								>
									<svg
										...
										fill="currentColor"
									>
										<path d="M18.825 23.859c-.022.023-.118.023-.146 0l-7.23-10.978-2.453 2.457v8.435c0 .02-.016.035-.035.035h-3.951c-.02 0-.035-.016-.035-.035v-23.717c0-.022.016-.035.035-.035h3.951c.02 0 .035.016.035.035v12.235l2.447-2.45 7.152-11.459c.022-.056.12-.056.146 0h4.425c.023 0 .044.028.026.049l-8.503 12.872 8.653 12.815c.012.02.011.05-.022.05h-4.425z" />
									</svg>
								</a>
							)}
			...
			{hasData(projects) && (
				<section id="projects">
					<SectionHeading subtitle="Research-oriented & System-level implementations">
						Featured Projects
					</SectionHeading>
						...
						<div className="grid two-col">
							{hasData(career_goals.short_term) && (
								<div>
									...
									<ul className="dot-list">
										{career_goals.short_term.map((g, i) => (
											<li key={i}>{g}</li>
										))}
									</ul>
								</div>
							...
							{hasData(career_goals.long_term) && (
								<div>
									...
									<ul className="dot-list">
										{career_goals.long_term.map((g, i) => (
											<li key={i}>{g}</li>
										))}
									</ul>
								</div>
			...
			<footer id="contact" className="footer">
				<div className="footer-content">
					...
					<p>
						Open to internship opportunities, collaborations, and exciting
						projects.
					</p>
